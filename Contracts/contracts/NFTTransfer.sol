...
contract NFTTransfer is ReentrancyGuard {
    ...
    function createCertificate(address nftContract, uint256 tokenId)public payable nonReentrant
    {
        require(
        ...
        // Transferring the NFT contract from the User to the Address of this contract
