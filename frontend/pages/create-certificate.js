        ...
        <div className="flex justify-center mt-[90px] pt-10">
            <div className="w-1/2 flex flex-col pb-12">
                <input
                    ...
                    className="mt-8 border rounded p-4 bg-indigo-500/25 border-indigo-500/50 text-white"
                    onChange={e => updateFormInput({ ...formInput, name: e.target.value })}
                />
                <textarea
                    placeholder="Certificate Description"
                    className="mt-2 border rounded p-4 bg-indigo-500/25 border-indigo-500/50"
                    onChange={e => updateFormInput({ ...formInput, description: e.target.value })}
                />
                <input
                    type="file"
                    name="Asset"
                    className="my-4 bg-indigo-500/25 text-white"
                    onChange={onChange}
                />
                {
                    fileUrl && (
