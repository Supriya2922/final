...
export default function HomePage() {
    ...
    async function loadNFTs() {
      ...
      //const provider = new ethers.providers.JsonRpcProvider("https://polygon-mumbai.g.alchemy.com/v2/5hDSqTS6_nBHtaTjuxBT1gcr3J-6z3BS");
    ...
    if (loadingState === "loaded" && !nfts.length) return (
      <h1 className="px-20 py-10 text-3xl text-white" >No Certificates Created or Left to Transfer</h1>
    );
  
    return (
      <div className="flex justify-center mt-[90px] pt-10">
